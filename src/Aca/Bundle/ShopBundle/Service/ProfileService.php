...
class ProfileService {
    ...
    /**
     * Returns a full list of all 51 US states and DC
     * @return array
     */
    public function getStateAbbreviations() {

        return array("AL","AK","AZ","AR","CA","CO","CT","DE","FL","GA","HI","ID","IL","IN","IA","KS","KY","LA","ME","MD","MA","MI","MN","MS","MO","MT","NE","NV","NH","NJ","NM","NY","NC","ND","OH","OK","OR","PA","RI","SC","SD","TN","TX","UT","VT","VA","WA","WV","WI","WY","DC");
    }
}